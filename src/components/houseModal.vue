<template>
    <div class="modal fade" id="houseModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
     <div class="modal-dialog">
       <div class="modal-content">
         <div class="modal-header">
           <h1 class="modal-title fs-5" id="staticBackdropLabel"><i class="fa-solid fa-house-medical"></i> Nova Casa</h1>
         ...
         <div class="modal-body">
           <div class="row gap-1 justify-content-center ">
            <div class="col-md-10 mb-2">
                ...
                <inputs input-type="text" icon="fa-solid fa-list-ol" pHolder="Nº da casa"/>
            </div>
            <div class="col-md-10 mb-2">
                <span class="fw-semibold mb-2">Nome da Casa</span>
                <inputs input-type="text" icon="fa-solid fa-house-chimney-crack" pHolder="Nome da casa"/>
            </div>
           </div>
         </div>
